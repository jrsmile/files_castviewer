...
* This repository ([PDF viewer](https://github.com/nextcloud/files_castviewer/issues)) is *only* for issues within the PDF viewer code.
...
[template]: https://raw.github.com/nextcloud/files_castviewer/master/.github/issue_template.md
